...
async def main():
    ...
    """
    parser = argparse.ArgumentParser(description='UnitAPI Speaker Playback Example')
    ...
    if args.local:
        ...
        if speakers:
            ...
            print("No speakers available. Run the device discovery service first.")
