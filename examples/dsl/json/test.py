...
# -*- coding: utf-8 -*-
"""
UnitAPI DSL JSON Configuration Test

This script demonstrates how to load, validate, and execute JSON configuration files.
"""
...
async def main():
    """Main function to test JSON configuration files"""
    # Parse command line arguments
    import argparse
    parser = argparse.ArgumentParser(description='UnitAPI DSL JSON Configuration Test')
    parser.add_argument('--config', default='example.json', 
                        help='Path to the JSON configuration file (default: example.json)')
    parser.add_argument('--dry-run', action='store_true', help='Validate without executing')
    parser.add_argument('--convert-to', choices=['yaml', 'hcl', 'star', 'ua'], 
