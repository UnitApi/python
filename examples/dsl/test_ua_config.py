...
# -*- coding: utf-8 -*-
"""
UnitAPI DSL Simple UA Configuration Test

This script demonstrates how to load, validate, and execute Simple UA configuration files.
"""
...
async def main():
    """Main function to test Simple UA configuration files"""
    # Parse command line arguments
    import argparse
    parser = argparse.ArgumentParser(description='UnitAPI DSL Simple UA Configuration Test')
    parser.add_argument('--config', default='input_devices.ua', 
                        help='Path to the Simple UA configuration file (default: input_devices.ua)')
    parser.add_argument('--dry-run', action='store_true', help='Validate without executing')
    parser.add_argument('--convert-to', choices=['yaml', 'hcl', 'star'], 
                        help='Convert the configuration to another format')
    parser.add_argument('--list-devices', action='store_true', 
                        help='List all devices in the configuration')
