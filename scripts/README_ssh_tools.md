...
This directory contains Python-based SSH tools for connecting to and managing remote devices in the UnitAPI project.
...
Install the UnitAPI Remote Keyboard Server on a Raspberry Pi:
...
- Interactive shell
- Verbose logging
- Remote installation of UnitAPI services
