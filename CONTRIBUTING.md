# Współpraca nad projektem unitapi

Dziękujemy za zainteresowanie projektem unitapi! Poniżej znajdziesz informacje, jak możesz przyczynić się do rozwoju biblioteki.
...
```bash
git clone https://gitlab.com/unitapi/python.git
cd unitapi
```
...
Projekt unitapi koncentruje się na tworzeniu bezpiecznych narzędzi dla dzieci. Prosimy o przestrzeganie następujących zasad:
...
Dziękujemy za Twój wkład w projekt unitapi!